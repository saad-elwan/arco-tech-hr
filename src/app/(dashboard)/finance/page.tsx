    ...
    <>
      ...
      <div className="page-header" style={{ marginBottom: 0 }}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          ...
          <button className="btn btn-ghost" onClick={() => window.open(`/print/payroll?period=${selectedPeriod}`, '_blank')} title="تصدير تقرير PDF" style={{ border: '1px solid rgba(239, 68, 68, 0.2)', color: 'var(--danger)', whiteSpace: 'nowrap', background: 'rgba(239, 68, 68, 0.05)' }}>
