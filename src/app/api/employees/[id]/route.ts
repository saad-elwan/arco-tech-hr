...
export async function PUT(
  ...
  const updateData: Record<string, unknown> = {
    ...
    basicSalary: data.basicSalary !== undefined && data.basicSalary !== "" ? parseFloat(data.basicSalary) : undefined,
    maxAdvanceLimit: data.maxAdvanceLimit !== undefined && data.maxAdvanceLimit !== "" ? parseFloat(data.maxAdvanceLimit) : undefined,
    status: data.status,
